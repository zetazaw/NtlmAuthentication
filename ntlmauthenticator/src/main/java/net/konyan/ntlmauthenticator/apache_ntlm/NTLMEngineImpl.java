...
package net.konyan.ntlmauthenticator.apache_ntlm;

import android.util.Base64;


import net.konyan.ntlmauthenticator.apache_ntlm.exception.NTLMEngineException;
import net.konyan.ntlmauthenticator.apache_ntlm.util.EncodingUtils;
...
/**
 * http://hc.apache.org/httpclient-3.x/license.html
 *
...
public final class NTLMEngineImpl implements NTLMEngine {
     ...
     * @return The response.
     * @throws net.konyan.ntlmauthenticator.apache_ntlm.exception.NTLMEngineException
     ...
     * username and the checkInResult of encrypting the nonce sent by the server using
